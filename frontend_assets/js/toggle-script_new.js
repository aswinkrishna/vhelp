   ...
   // alert();
    $("#slider-range").slider({
        ...
        slide: function( event, ui ) {
            $( ".price_wrap" ).html( "<p class='slider-amount-1'> Min Price <span>AED <span  id='price_from'> " + ui.values[ 0 ] + "</span></span></p> <p  class='slider-amount-2' >Max Price <span> AED<span id='price_to'>" + ui.values[ 1 ] + "</span></span></p>");
      }
    });
...
$('.time_slotes .badge').click(function(event){
    str = event.target.className;
    var ret = str.split(" ");
    if(ret[1] == 'slot_disabled'){
        // alert('slot_disabled');
        return false;
    }
