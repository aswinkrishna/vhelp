...
$.fn.zabuto_calendar = function (options) {
                ...
                for (var dow = 0; dow < 7; dow++) {
                    if (dow < firstDow || currDayOfMonth > lastDayinMonth) {
                        ...
                        if (isToday(year, month, currDayOfMonth)) {
                            ...
                            $dayElement.addClass('todayDate');
                            if ($calendarElement.data('showToday') === true) {
                                $dayElement.html('<span class="badge badge-today">' + currDayOfMonth + '</span>');
                            }
                            // $('.today').addClass('Goood');
                        }
    ...
    function disableDateFunction(){
            
        $('.todayDate').parents('tr').prevAll().find('td .day').addClass('disabled');
        $('.todayDate').parents('td').prevAll().find('.day').addClass('disabled');
        // $('.todayDate').addClass('disabled');
