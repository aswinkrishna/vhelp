                                        ...
                                        <td>
                                            <div style="padding: 15px 20px; background:#e2e2e2; padding-bottom: 15px;">
                                                <table style="background:#e2e2e2; font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-size:14px;width: 100%;">
                                                    <tbody>
                                                        <tr>
                                                            <td style="width: 75%;"><img style="width: 100px;" src="<?php echo base_url(); ?>template/images/header-logo.png" alt="">
                                                                <h1 style="color: #0e688d; font-size: 25px; line-height: 26px; margin:30px 0 0 0;">Registration Successfull!
                                                                </h1>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td valign="top" style="padding-bottom: 0px;">
                                                                            <div style="color:#000;font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-size:14px;line-height:150%;text-align:left;margin-top: 30px">
                                                                                <h4 style="font-size: 16px;">Hi <?=$user_name?>,</h4>
                                                                                <br style="margin:0;padding:0">
                                                                                <p style="margin:0;padding:0;margin-bottom:5px;color:#585858;font-weight:400;font-size:13px;line-height:1.6">Welcome to <span><?=SITE_NAME?></span> family!</p>
                                                                                <br style="margin:0;padding:0">
                                                                                <p style="margin:0;padding:0;margin-bottom:5px;color:#585858;font-weight:400;font-size:13px;line-height:1.6">
                                                                                    <?php
                                                                                        if($message)
                                                                                            ...
                                                                                            echo "Your account will be activated after verification. We will let you know, once the verification is completed.";
                                                                                    ?>
                                                                                </p>
                                                                            </div>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <p style="color: #000; font-size: 16px; margin: 0px 0px 10px; text-align: left;">Team <?=SITE_NAME?></p>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
