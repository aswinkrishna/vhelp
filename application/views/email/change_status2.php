...
<body style="margin: 0;padding: 0;  background-color: #eaeaea;  font-family: 'Maven Pro', sans-serif !important;margin-top: 100px;">
    <table style=" max-width: 600px;width: 600px;margin-top: 100px; margin: auto;">
        <tr>
            <td style="width: 10%">
        ...
        <tr>
            <td
                ...
                <img src="<?php echo base_url();?>frontend_assets/email_template/banner-1.jpg" style="height: auto;
                width: 100%;
              position: absolute;
              top: 0;
              left: 0;" />
                <table style="text-align: left">
                    <tr>
                        ...
                        <td>
                            <span style="position: relative;z-index: 9;font-weight: bold;font-size: 18px;color: #fff">
                               {subject}
                            </span><br>
                        </td>
                    </tr>
        ...
        <table style="margin: 0px auto;background: #fff">
            ...
            <tr>
                ...
                <td colspan="2">
                    <p style="padding: 15px;line-height: 1.5em;font-weight: 500;margin: 0;color: #d72d30">Thanks</p>
    ...
    <table style="margin: 15px auto;padding:10px 0;text-align: center">
        <tr>
            ...
            <td style="color: #000;font-size: 15px;font-weight: 500">
                If you need help, write to us at <a href="#" style="text-decoration: none"><span
                        style="color: #d72d30">emiratesquotation@gmail.com</span></a>
        ...
        <tr>
            ...
            <td style="color: #4b4b4b;font-size: 12px;font-weight: 500">
                Email sent by Emirates Quotations
            </td>

        </tr>
        <tr>
            <td style="color: #4b4b4b;font-size: 12px;font-weight: 500">
                © VEE HELP TECHNOLOGIES PVT LTD. INDIA
            </td>
        </tr>
    </table>
