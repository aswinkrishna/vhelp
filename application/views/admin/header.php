...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?php  echo base_url();?>admin"><img src="<?php echo base_url();?>images/admin_logo.png" style="width:75%;"></a>
...
<!--    <li><a class="dropdown-item" href="page-user.html"><i class="fa fa-cog fa-lg"></i> Settings</a></li>-->
            <li><a class="dropdown-item" href="<?php  echo base_url();?>admin/change_password"><i class="fa fa-user fa-lg"></i> Change password</a></li>
            <?php
             if($this->session->userdata("language")==1 || $this->session->userdata("language")!=2)
             {
            ?>
                <li><a class="dropdown-item" href="javascript:toggleLanguage(2)"><i class="fa fa-user fa-lg"></i> Arabic</a></li>
           
            <?php
             }else
             {
            ?>
                <li><a class="dropdown-item" href="javascript:toggleLanguage(1)"><i class="fa fa-user fa-lg"></i> English</a></li>
             <?php
             }
             ?>
