          ...
          <div class="col-md-12">
                <div class="col-md-8 col-md-offset-12">
                                              <?php
                                                        ...
                                                        {
                                                       ?>
                    <a href="<?php echo base_url();?>admin/add_edit_slider"> <button class="btn btn-primary" type="button">Add Slider</button></a>
                 <?php
                                                        }
                                                       ?>
                </div>
    ...
    <?=get_date_in_timezone('Asia/Dubai', $rows->created_on, 'd-m-Y h:i A');?>
                    ...
                    <td>
                        <?php
                                                        ...
                                                        {
                                                        ?>
                                                 <a class="edit" href="<?php echo base_url();?>admin/add_edit_slider/<?php echo $this->common_functions->encryptId($rows->slider_id);  ?>">  <i class="fa fa-pencil" i=""></i></a> &nbsp; &nbsp;&nbsp; &nbsp;    
                                                <?php
                                                        }
                                                        ?>
                                                  <?php
...
.then((willDelete) => {
  if (willDelete) {
            ...
            csrf_value  =   getCookie('csrf_cookie_name');    
             ...
             $.ajax({
            url:  '<?php echo base_url();?>admin/C_admin/deleteAppSlider',
            type: 'POST',
     ...
     $(document).delegate(".swichCheck","change",function(e)
    {
		...
		else
		{
			...
			csrf_value  =   getCookie('csrf_cookie_name');    
			 $.ajax({
            url:  '<?php echo base_url();?>admin/C_admin/changeSliderStatus',
            type: 'POST',
