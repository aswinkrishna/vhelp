...
<main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i>Country list</h1>
          ...
          <div class="col-md-12">
                <div class="col-md-8 col-md-offset-12">
                    <?php
                                                        ...
                                                        {
                                                       ?>
                    <a href="<?php echo base_url();?>admin/add_edit_country"> <button class="btn btn-primary" type="button">Add new country</button></a>
                                                 <?php
                                                        }
                                                       ?>
                </div>
...
<!--                    <th>Approve</th>-->
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php  echo $rows->country_dial_code; ?></td>
                    <td><?php  echo $rows->country_created_date; ?></td>                  
                    <td><?php  echo $rows->country_status==1?"Active":"Inactive"; ?></td>
  ...
  <span class="slider round"></span>
                    ...
                    <td>
                        <?php
                                                        ...
                                                        {
                                                        ?>
                                                 <a class="edit" title="Edit" href="<?php echo base_url();?>admin/add_edit_country/<?php echo $this->common_functions->encryptId($rows->country_id);  ?>">  <i class="fa fa-pencil" i=""></i></a> &nbsp; &nbsp;&nbsp; &nbsp;    
                                                 <?php
                                                        }
                                                        ?>
                                                 <?php
                                                        ...
                                                        {
                                                        ?>
                                                 <a class="remove" title="Delete" href="javascript:void(0)" > <i class="fa fa-trash-o removeThis" for="<?php echo $this->common_functions->encryptId($rows->country_id);  ?>"></i></a>&nbsp; &nbsp;&nbsp; &nbsp;    
                                                          <?php
                                                         }
                                                        ?>
...
.then((willDelete) => {
  if (willDelete) {
            ...
            csrf_value  =   getCookie('csrf_cookie_name');    
             ...
             $.ajax({
            url:  '<?php echo base_url();?>admin/C_admin/deleteCountry',
            type: 'POST',
