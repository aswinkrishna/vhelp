<main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> City</h1>
<!--          <p>Sample forms</p>-->
        </div>
<!--        <ul class="app-breadcrumb breadcrumb">
     ...
     <?php
                     ...
                     $saveButtonName  = "Add";
                      if($id>0)
                      {
                               ...
                               $saveButtonName  = "Update";
                                ...
                                $englishName                 =   $records1->city_name;
                                $arabicName                   =   $records2->city_name;
                                $countryId                       =   $records1->city_country_id;
                                $status                              =   $records1->city_status;
                      }
                      else
                      {
                               $englishName                 =   "";
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">City <?php  echo $label; ?></h3>
            <div class="tile-body">
                    ...
                    if($id>0)
                      {
                        ...
                        ?>
                                <input type="hidden" class="form-control boxed" placeholder="" name="txt_city_id" value="<?php echo $id; ?>"> 
                        <?php
               ...
               ?>
                   ...
                   <div class="col-md-6">
                                ...
                                <label class="control-label">Country</label>
                                 <select class="c-select form-control boxed" name="txtCountry">
                            ...
                            ?>
                                        ...
                                        <option value="<?php echo $rows->country_id; ?>" <?php  if($countryId==$rows->country_id){ echo "selected" ;} ?> ><?php echo $rows->country_name; ?></option>
     ...
     submitHandler: function ()
        {
                ...
                var formData = new FormData($("#cityForm")[0]);
                 ...
                 formData.append('<?php echo $this->security->get_csrf_token_name();?>',csrf_value);
                     ...
                     $.ajax({
             url: '<?php echo base_url();?>admin/C_admin/saveCity',
             type: 'POST',
             data: formData,
             async: true,
                    ...
                    if(data['status']==1)
                    {
                         $(".error").html("");// clear all errors
                          swal("Well done!", "Saved Successfully!", "success");
                              window.location= "<?php echo base_url();?>admin/city_list";  
                    }
