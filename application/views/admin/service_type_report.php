...
<main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i>&nbsp;Service type report</h1>
          ...
          <div class="tile">
            <div class="tile-body" >
              <section class="example">
                                            ...
                                            <a href="<?php echo base_url();?>admin/C_admin/userReportDownLoad/1/2" id="exportToPdf" for="1"><i class="fa fa-file-pdf-o fa-2x" style="color:red" title="Export to PDF"></i></a> &nbsp;&nbsp; <a href="<?php echo base_url();?>admin/C_admin/userReportDownLoad/2/2"><i class="fa fa-file-excel-o fa-2x" aria-hidden="true" style="color:green" title="Export to Excel"></i></a>
...
function listServiceTypes()
{
          ...
          $.ajax( {
						type: 'POST',
						url: '<?php echo base_url();?>admin/C_admin/listServiceTypeAjax',
						data: formVal ,
