...
<main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i>City list</h1>
...
<!--                    <th>Approve</th>-->
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php  echo $rows->city_created_date; ?></td>                  
                    <td><?php  echo $rows->city_status==1?"Active":"Inactive"; ?></td>
  ...
  <span class="slider round"></span>
                    ...
                    <td>
                        <?php
                                                        ...
                                                        {
                                                        ?>
                                                 <a class="edit" href="<?php echo base_url();?>admin/add_edit_city/<?php echo $this->common_functions->encryptId($rows->city_id);  ?>">  <i class="fa fa-pencil" i=""></i></a> &nbsp; &nbsp;&nbsp; &nbsp;    
                                                <?php
                                                        }
                                                        ?>
                                                  <?php
                                                        ...
                                                        {
                                                        ?>
                                                 <a class="remove" href="javascript:void(0)" > <i class="fa fa-trash-o removeThis" for="<?php echo $this->common_functions->encryptId($rows->city_id);  ?>"></i></a>&nbsp; &nbsp;&nbsp; &nbsp;    
                                                     <?php
                                                        }
                                                        ?>
...
.then((willDelete) => {
  if (willDelete) {
            ...
            csrf_value  =   getCookie('csrf_cookie_name');    
             ...
             $.ajax({
            url:  '<?php echo base_url();?>admin/C_admin/deleteCity',
            type: 'POST',
