<main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i>App slider</h1>
<!--          <p>Sample forms</p>-->
        </div>
     ...
     <?php
                     ...
                     $saveButtonName  = "Save";
                      if($id>0)
                      {
                                ...
                                $records1        =  $this->M_admin->getAppSliderById($id);
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title"> <?php  echo $label; ?> Slider</h3>
            <div class="tile-body">
              ...
              $(".errorSpan1").html("");                 
                ...
                var formData = new FormData($("#sliderForm")[0]);
                 ...
                 formData.append('<?php echo $this->security->get_csrf_token_name();?>',csrf_value);
                     ...
                     $.ajax({
             url: '<?php echo base_url();?>admin/C_admin/saveAppSlider',
             type: 'POST',
             data: formData,
             async: true,
