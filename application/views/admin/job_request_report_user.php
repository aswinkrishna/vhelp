...
if (in_array("quotation_list", $urlArray) )
  ...
  {
      $labelrequests      =  "Eq recommended list";
  } 
  else if (in_array("view_user_quotations", $urlArray) )
  {
     $labelrequests      =  "Quotation list(Customer)";
  }
  else
  {
      $labelrequests      =  "Eq recommended list";
...
<div id="myModal" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" id="detailDiv">
       ...
       <div id="map" class="modal-body" style="width:200px"></div>   
...
<div id="myModal3" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" id="providerResponseDiv">
         ...
         <input type="" id="job_request_id2" value="">
         <input type="" id="provider_id2" value="">
      </div>
      <div class="modal-footer">
 ...
 <!-- Modal -->
 <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCHFZ49O5XuPD9RR-s0grdzBoV4wAZxJB8"></script>
<script>
...
function listJobRequests()
{
             ...
             <?php if($job_request_type>0) {?>
                     ...
                     ?>
              <?php if($user_id>0) {?>
                       formVal.push({ name: "user_id", value:<?php  echo $user_id;?> });
                     <?php 
             }
                     ?>
          ...
          $.ajax( {
						type: 'POST',
						url: '<?php echo base_url();?>admin/C_admin/listJobRequestsAjaxUser',
						data: formVal ,
  ...
  if (willDelete) {
     ...
     $(document).delegate(".detailView","click",function(e)
    {
         ...
         csrf_value  =   getCookie('csrf_cookie_name');        
          $("#detailDiv").html("");
          $.ajax({
            url: '<?php echo base_url();?>admin/C_admin/getJobRequestDetailsForUser',
            type: 'POST',
    ...
    $(document).delegate("#btnSavePrice","click",function(e)
    {
          ...
          $.ajax({
            ...
            type: 'POST',
            data: {job_request_id:job_request_id,provider_id:provider_id,price:price,'<?php echo $this->security->get_csrf_token_name();?>':csrf_value},
            success: function (data) 
	  {
      ...
      $(document).delegate(".btnApprove","click",function(e)
       {
          ...
          $.ajax({
            url: '<?php echo base_url();?>admin/C_admin/approveProvider',
            type: 'POST',
            data: {job_request_id:job_request_id,provider_id:provider_id,'<?php echo $this->security->get_csrf_token_name();?>':csrf_value},
            success: function (data) 
	  {
              data =  jQuery.parseJSON(data);
              if(data['status']==1)
                    {
                         ...
                         swal("Well done!", "The provider has been approved!", "success");
                         $("#myModal").modal("hide");
                    ...
                    else if(data['status']==0)
                    {
                          if(data['errors'] !== ""){
                           ...
                           swal("Sorry!", "Failed to approve! Try again later", "error");
                          }
                    ...
                    {
                         swal("Sorry!", "Already approved! Try again later", "error");
                    }
                    else
                    {
