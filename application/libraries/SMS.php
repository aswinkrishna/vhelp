...
class  SMS {
    ...
    function __construct() {
        ...
        $this->username         = "Emiratesquotation";//username
        $this->password         = "56757456";//password
    ...
    public function send_normal_SMS($message, $mobile_numbers, $sender_id="") {
       ...
       // $mobile_numbers ="971505041860";
     //   $this->url."User=".$this->username."&passwd=".$this->password."&mobilenumber=".$mobile_number ."&message=".$message."&sid=".$senderId."&mtype=".$this->message_type."&DR=".$this->delivery_report;
        ...
        curl_setopt($ch, CURLOPT_POSTFIELDS,"User=".$this->username."&passwd=".$this->password."&mobilenumber=".$mobile_numbers ."&message=".$message."&sid=".$senderId."&mtype=".$this->message_type."&DR=".$this->delivery_report);
